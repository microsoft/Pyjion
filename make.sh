...
clang++-3.5 -DPLATFORM_UNIX=1 -std=c++11 Test/Test.cpp -o Test/test.o  -fPIC -g -D_TARGET_AMD64_=1  -IPyjion/ $PY_INC_DIRS $OUT_DIR/pyjion.so Python/libpython3.6m.a -ldl -lpthread -lutil -lnuma

clang++-3.5 -DPLATFORM_UNIX=1 -std=c++11 Tests/Tests.cpp Tests/test_emission.cpp Tests/test_inference.cpp Tests/testing_util.cpp -o Tests/tests.o -fPIC -g -D_TARGET_AMD64_=1 -ITests/Catch/include/ -IPyjion/ $PY_INC_DIRS $OUT_DIR/pyjion.so Python/libpython3.6m.a -ldl -lpthread -lutil -lnuma
