...
# -*- coding: utf-8 -*-
#
# Pyjion documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pyjion', 'Pyjion Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Pyjion', 'Pyjion Documentation',
   author, 'Pyjion', 'One line description of project.',
   'Miscellaneous'),
]
